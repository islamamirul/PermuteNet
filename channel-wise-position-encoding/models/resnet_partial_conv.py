...
class ResNetPartialPosition(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, num_location=9):
        super(ResNetPartialPosition, self).__init__()
        self.in_planes = 64

        self.conv1 = PartialConv2d(3, 64, kernel_size=7, stride=2, padding=3, bias=False)
...
class ResNetPartialSemanticPosition(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, num_location=9):
        super(ResNetPartialSemanticPosition, self).__init__()
        self.in_planes = 64
        ...
        # self.semantic_location = nn.Sequential(
        #     OrderedDict([
        #         ('conv5_4', PartialConv2d(512, 256, 3, 1, 1, 1)),
        #         ('conv5_4_bn', nn.BatchNorm2d(256)),
        #         ('conv5_4_relu', nn.ReLU()),
        #         ('drop5_4', nn.Dropout2d(p=0.1)),
        #         ('conv6', PartialConv2d(256, num_classes, 1, stride=1, padding=0)),
        #     ])
        # )
        #
...
class ResNetNoPoolingPosition(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, num_location=9):
        super(ResNetNoPoolingPosition, self).__init__()
        self.in_planes = 64
...
def ResNet18PartialPosition(grid_size=3, num_class=10):
    print('Partial Padding')
    return ResNetPartialPosition(BasicBlock, [2, 2, 2, 2], num_classes=num_class, num_location=grid_size*grid_size)


def ResNet18PartialSemanticPosition(grid_size=3, num_class=11):
    print('Partial Padding')
    return ResNetPartialSemanticPosition(BasicBlock, [2,2,2,2], num_classes=num_class, num_location=grid_size*grid_size)
